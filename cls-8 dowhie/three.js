let emps=[{"id":1,"ename":"Mickie","email":"mbixley0@theglobeandmail.com","gender":"Genderfluid"},
...
/* console.log(typeof (emps));//object
console.log(emps.length);//60 */
